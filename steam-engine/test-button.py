...
button_array = []
button_array.append(Button(22,"/home/pi/steam-engine/buttons/bell"))
button_array.append(Button(23,"/home/pi/steam-engine/buttons/whistle"))
button_array.append(Button(24,"/home/pi/steam-engine/buttons/chuff"))
button_array.append(Button(27,"/home/pi/steam-engine/buttons/music", stop_if_depress=True))
...
right.start()
left.start()
os.system("mpg321 -q /home/pi/steam-engine/buttons/whistle/bigboy-whistle.mp3")
right.stop()
left.stop()
last_played_time = time()
